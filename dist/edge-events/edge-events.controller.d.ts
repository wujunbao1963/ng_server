...
export declare class EdgeEventsController {
    ...
    constructor(contracts: ContractsValidatorService, svc: EdgeEventsService, manifests: IncidentManifestsService, circles: CirclesService);
    listEvents(req: {
        user: JwtUser;
    ...
    summaryUpsert(circleId: string, body: unknown): Promise<{
        ok: boolean;
        applied: boolean;
