...
const contracts_validator_service_1 = require("./contracts-validator.service");
...
exports.ContractsModule = ContractsModule = __decorate([
    (0, common_1.Module)({
        providers: [contracts_validator_service_1.ContractsValidatorService],
        exports: [contracts_validator_service_1.ContractsValidatorService],
    })
], ContractsModule);
