...
let IncidentReadService = class IncidentReadService {
    constructor(repo) {
        this.repo = repo;
    }
    async getManifest(circleId, eventId) {
...
exports.IncidentReadService = IncidentReadService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(ng_incident_manifest_entity_1.NgIncidentManifest)),
