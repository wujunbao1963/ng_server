...
exports.OutboxModule = OutboxModule = __decorate([
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([ng_outbox_entity_1.NgOutbox, ng_push_device_entity_1.NgPushDevice, ng_notification_entity_1.NgNotification]),
        ],
        providers: [
            outbox_service_1.OutboxService,
            push_notification_handler_1.PushNotificationHandler,
            {
                provide: outbox_worker_1.OUTBOX_HANDLERS,
