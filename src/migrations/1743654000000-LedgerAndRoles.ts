...
/**
 * Phase 4 Migration: Ledger Ingest and Roles
 * 
 * Creates tables for:
 * - ng_ledger_entries: Edge ledger entries synced to server
 * - ng_roles: Role assignments
 * - ng_role_audit: Role change audit log
 */
export class LedgerAndRoles1743654000000 implements MigrationInterface {
  name = 'LedgerAndRoles1743654000000';
