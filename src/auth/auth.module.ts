...
import { AuthController, CircleAuthController } from './auth.controller';
...
@Module({
  imports: [
    ConfigModule,
    TypeOrmModule.forFeature([NgUser, NgRole, NgCircle]),
  ...
  controllers: [AuthController, CircleAuthController],
